        ...
        <div class="card-body">
            ...
            <form action="{{ route('property.update', $property->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <input value="{{$property->name}}" id="name" name="name" type="text" class="form-control" placeholder="Product Name">
                </div>
                <div class="mb-3">
                    <label for="detail" class="form-label">Detail property Name <span class="text-danger">*</span></label>
